...
layerstack = {
    ...
    (18,0): (0.748, 1.135, 'V2'),    
    (19,0): (0.783, 1.135, 'M3'),       
    # (212,235): (0, 0.1, 'PHOTON'),    
    # (212,250): (0, 0.1, 'MODULATOR'),    
    # (212,32): (0, 0.1, 'WAVEGUIDEPIN'),    
    (578,0): (1.17, 1.855, 'M4'),    
    (579,0): (1.89, 2.575, 'M5'),    
    (580,0): (1.135, 1.855, 'V3'),    
    (581,0): (1.855, 2.575, 'V4'),     
    # (636,32): (0, 0.1, 'OPTICAL_PIN'),    
    # (722,0): (0, 0.1, 'WAVEGUIDE_REG'),
    (3715,0): (0.05, 0.16, 'KG'),    # Rib etch
    (3716,0): (0.16, 0.165, 'IH'),    # p type rib implant     
    (3717,0): (0.16, 0.165, 'IJ'),    # n type rib implant
    (3746,0): (0.16, 0.17, 'PLN'),   # n++ type implant
    (3747,0): (0.16, 0.17, 'PLP'),   # p++ type implant 
    # (3758,0): (0, 0.1, 'OBAND'),
